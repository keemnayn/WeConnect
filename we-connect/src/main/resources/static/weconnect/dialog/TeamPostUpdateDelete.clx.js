...
(function() {
	var app = new cpr.core.App("dialog/TeamPostUpdateDelete", { 
		...
		onCreate: function(/* cpr.core.AppInstance */ app, exports) {
			...
			var dataMap_1 = new cpr.data.DataMap("teamPostDeleteParam");
			dataMap_1.parseData({
				"columns" : [
					{"name": "teamPostTitle"},
			...
			var submission_2 = new cpr.protocols.Submission("teamPostDetailSub");
			submission_2.method = "get";
			submission_2.action = "member/teams/detail";
			...
			(function(container){
				...
				(function(container){
					...
					var dataMapContext_1 = new cpr.bind.DataMapContext(app.lookup("teamPostDeleteParam"));
					inputBox_1.setBindContext(dataMapContext_1);
					inputBox_1.bind("value").toDataMap(app.lookup("teamPostDeleteParam"), "teamPostContent");
				...
				output_2.value = "새글이 지속적으로 업로드되는 팀보드의 특성상 삭제만 가능하오니 참고바랍니다.";
				...
				(function(container){
					...
					var dataMapContext_2 = new cpr.bind.DataMapContext(app.lookup("teamPostDeleteParam"));
					inputBox_2.setBindContext(dataMapContext_2);
					inputBox_2.bind("value").toDataMap(app.lookup("teamPostDeleteParam"), "teamPostTitle");
				...
				(function(container){
					...
					output_4.value = "프로젝트명";
					container.addChild(output_4, {
						"colIndex": 0,
						"rowIndex": 0
					});
					var output_5 = new cpr.controls.Output("projectNameOpb");
					output_5.value = "projectName";
				...
				var output_6 = new cpr.controls.Output("TMemberIdOpb");
				output_6.visible = false;
				output_6.bind("value").toDataMap(app.lookup("teamPostDeleteParam"), "TMemberId");
