/*
 * App URI: dialog/RoomReservUpdate
 * Source Location: dialog/RoomReservUpdate.clx
 *
 * This file was generated by eXBuilder6 compiler(1.0.4584), Don't edit manually.
 */
(function() {
	var app = new cpr.core.App("dialog/RoomReservUpdate", { 
		...
		onCreate: function(/* cpr.core.AppInstance */ app, exports) {
			...
			var dataMap_1 = new cpr.data.DataMap("roomReservUpdateParam");
			dataMap_1.parseData({
				"columns" : [
					{"name": "roomReservDate"},
					{
			...
			(function(container){
				...
				var dataMapContext_1 = new cpr.bind.DataMapContext(app.lookup("roomReservUpdateParam"));
				dateInput_1.setBindContext(dataMapContext_1);
				dateInput_1.bind("value").toDataMap(app.lookup("roomReservUpdateParam"), "roomReservDate");
				...
				var dataMapContext_2 = new cpr.bind.DataMapContext(app.lookup("roomReservUpdateParam"));
				comboBox_1.setBindContext(dataMapContext_2);
				comboBox_1.bind("value").toDataMap(app.lookup("roomReservUpdateParam"), "roomReservStartTime");
				(function(comboBox_1){
				...
				var dataMapContext_3 = new cpr.bind.DataMapContext(app.lookup("roomReservUpdateParam"));
				comboBox_2.setBindContext(dataMapContext_3);
				comboBox_2.bind("value").toDataMap(app.lookup("roomReservUpdateParam"), "roomReservEndTime");
				(function(comboBox_2){
				...
				var dataMapContext_4 = new cpr.bind.DataMapContext(app.lookup("roomReservUpdateParam"));
				comboBox_3.setBindContext(dataMapContext_4);
				comboBox_3.bind("value").toDataMap(app.lookup("roomReservUpdateParam"), "roomId");
				(function(comboBox_3){
			...
			(function(container){
				...
				var dataMapContext_5 = new cpr.bind.DataMapContext(app.lookup("roomReservUpdateParam"));
				inputBox_1.setBindContext(dataMapContext_5);
				inputBox_1.bind("value").toDataMap(app.lookup("roomReservUpdateParam"), "proposal");
			...
			var output_7 = new cpr.controls.Output("roomReservIdOutput");
			var dataMapContext_6 = new cpr.bind.DataMapContext(app.lookup("roomReservUpdateParam"));
			output_7.setBindContext(dataMapContext_6);
			output_7.bind("value").toDataMap(app.lookup("roomReservUpdateParam"), "roomReservId");
