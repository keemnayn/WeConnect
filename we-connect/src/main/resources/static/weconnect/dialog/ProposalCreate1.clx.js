/*
 * App URI: dialog/ProposalCreate1
 * Source Location: dialog/ProposalCreate1.clx
 *
 * This file was generated by eXBuilder6 compiler(1.0.4584), Don't edit manually.
 */
(function() {
	var app = new cpr.core.App("dialog/ProposalCreate1", { 
		...
		onCreate: function(/* cpr.core.AppInstance */ app, exports) {
			...
			// Header
			var dataSet_1 = new cpr.data.DataSet("dsStatus");
			dataSet_1.parseData({
				"columns": [{"name": "status"}],
				"rows": [
					{"status": "(선택)"},
			...
			(function(container){
				...
				(function(container){
					...
					var inputBox_2 = new cpr.controls.InputBox("PoposalTitleIpb");
