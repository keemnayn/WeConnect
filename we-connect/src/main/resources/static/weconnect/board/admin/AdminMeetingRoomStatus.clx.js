/*
 * App URI: board/admin/AdminMeetingRoomStatus
 * Source Location: board/admin/AdminMeetingRoomStatus.clx
 *
 * This file was generated by eXBuilder6 compiler(1.0.4584), Don't edit manually.
 */
(function() {
	var app = new cpr.core.App("board/admin/AdminMeetingRoomStatus", { 
		...
		onCreate: function(/* cpr.core.AppInstance */ app, exports) {
			...
			dataSet_1.parseData({
				...
				"rows": [
					{"회의실번호": "회의실번호1", "회의실명": "회의실명1"},
					{"회의실번호": "회의실번호2", "회의실명": "회의실명2"}
				]
			});
