/*
 * App URI: board/admin/AdminSuggestions
 * Source Location: board/admin/AdminSuggestions.clx
 *
 * This file was generated by eXBuilder6 compiler(1.0.4584), Don't edit manually.
 */
(function() {
	var app = new cpr.core.App("board/admin/AdminSuggestions", { 
		...
		onCreate: function(/* cpr.core.AppInstance */ app, exports) {
			...
			// Header
			var dataSet_1 = new cpr.data.DataSet("suggestionsList");
			dataSet_1.parseData({
				"columns": [
					{"name": "title"},
					{"name": "content"},
				...
				"rows": [
					{"title": "건의", "content": "건의합니다", "name": "박해준", "type": "시설", "date": "2023-08-27", "state": "완료"},
					{"title": "건의", "content": "건의합니다", "name": "박해준", "type": "시설", "date": "2023-08-27", "state": "처리중"},
					{"title": "건의", "content": "건의합니다", "name": "박해준", "type": "시설", "date": "2023-08-27", "state": "완료"},
					{"title": "건의", "content": "건의합니다", "name": "박해준", "type": "시설", "date": "2023-08-27", "state": "완료"},
					{"title": "건의", "content": "건의합니다", "name": "박해준", "type": "시설", "date": "2023-08-27", "state": "처리중"},
					{"title": "건의", "content": "건의합니다", "name": "박해준", "type": "시설", "date": "2023-08-27", "state": "완료"},
					...
					{"title": "건의", "content": "건의합니다", "name": "박해준", "type": "시설", "date": "2023-08-27", "state": "처리중"},
					{"title": "건의", "content": "건의합니다", "name": "박해준", "type": "시설", "date": "2023-08-27", "state": "완료"},
					{"title": "건의", "content": "건의합니다", "name": "박해준", "type": "비품", "date": "2023-08-27", "state": "완료"},
					{"title": "건의", "content": "건의합니다", "name": "박해준", "type": "시설", "date": "2023-08-27", "state": "처리중"},
					{"title": "건의", "content": "건의합니다", "name": "박해준", "type": "시설", "date": "2023-08-27", "state": "완료"},
					{"title": "건의", "content": "건의합니다", "name": "박해준", "type": "시설", "date": "2023-08-27", "state": "처리중"},
					{"title": "건의", "content": "건의합니다", "name": "박해준", "type": "시설", "date": "2023-08-27", "state": "완료"},
					{"title": "건의", "content": "건의합니다", "date": "2023-08-27", "name": "박해준", "type": "시설", "state": "처리중"}
				]
			});
			app.register(dataSet_1);
			
			var dataSet_2 = new cpr.data.DataSet("suggestionSearch");
			dataSet_2.parseData({
				"columns": [{"name": "type"}],
				"rows": [
					{"type": "전체"},
			...
			var tabItem_1 = (function(tabFolder){
				...
				(function(container){
					...
					grid_1.init({
						"dataSet": app.lookup("suggestionsList"),
						"columns": [
							{"width": "25px"},
							{"width": "100px"},
							{"width": "100px"},
								...
								},
								{
									...
									"configurator": function(cell){
										...
										cell.control = (function(){
											...
											output_5.bind("value").toDataColumn("date");
											return output_5;
										})();
										cell.controlConstraint = {};
									}
					...
					comboBox_1.value = "전체";
					(function(comboBox_1){
						comboBox_1.setItemSet(app.lookup("suggestionSearch"), {
							"label": "type",
							"value": "type"
						});
					})(comboBox_1);
