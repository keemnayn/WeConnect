/*
 * App URI: user/project/TeamPost
 * Source Location: user/project/TeamPost.clx
 *
 * This file was generated by eXBuilder6 compiler(1.0.4584), Don't edit manually.
 */
(function() {
	var app = new cpr.core.App("user/project/TeamPost", { 
		...
		onCreate: function(/* cpr.core.AppInstance */ app, exports) {
			...
			image_1.src = "user/img/user/attach-file.png";
			image_1.style.css({
				"font-family" : "IBM Plex Sans KR"
			});
			...
			image_2.src = "user/img/user/bookmark-white.png";
			image_2.style.css({
				"font-family" : "IBM Plex Sans KR"
			});
			...
			image_3.src = "user/img/user/attach-file.png";
			image_3.style.css({
				"font-family" : "IBM Plex Sans KR"
			});
			...
			image_4.src = "user/img/user/bookmark-white.png";
			image_4.style.css({
				"font-family" : "IBM Plex Sans KR"
			});
