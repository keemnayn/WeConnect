/*
 * App URI: member/project/TeamAllPost
 * Source Location: member/project/TeamAllPost.clx
 *
 * This file was generated by eXBuilder6 compiler(1.0.4584), Don't edit manually.
 */
(function() {
	var app = new cpr.core.App("member/project/TeamAllPost", { 
		...
		onCreate: function(/* cpr.core.AppInstance */ app, exports) {
			...
			dataSet_1.parseData({
				...
				"rows": [{"teamPostNo": "1", "memberName": "nana", "teamPostTitle": "새 소식", "date": "2023-08-16", "teamPostContent": "hohoho", "departmentName": "개발팀"}]
			});
			...
			submission_1.action = "member/teampost/teamPost.do";
